...
First clone the project (`git clone --recurse-submodules https://github.com/hgdebarba/SimpleRenderEngineProject.git`). You can use of the examples as starting point.
