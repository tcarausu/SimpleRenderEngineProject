...
static void ShowExampleAppCustomNodeGraph(bool* opened)
{
    ...
    // Open context menu
    auto mouseHovering = ImGui::IsWindowHovered(ImGuiHoveredFlags_AllowWhenBlockedByPopup | ImGuiHoveredFlags_AllowWhenBlockedByActiveItem);
    if (!ImGui::IsAnyItemHovered() && mouseHovering && ImGui::IsMouseClicked(1))
    {
